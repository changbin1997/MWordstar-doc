...
![MWordStar主题首页截图1](/docs/home.png)
...
![MWordStar深色模式截图](/docs/dark-color.png)
...
![MWordStar小头图模式截图](/docs/mini-header-image.png)

也可以给不同的文章设置不同的头图样式：

![MWordStar大头图和小头图搭配使用的截图](/docs/mini-header-image2.png)