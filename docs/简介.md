...
![MWordStar主题首页截图1](/docs/home-page.png)

主题元素包含圆角和直角两种风格，您可以根据喜好在主题外观设置中切换，下面是直角风格的首页截图：

![MWordStar直角风格首页截图](/docs/right-angle.png)

深色模式：

![MWordStar深色模式截图](/docs/dark-mode.png)

MWordStar 目前支持 18 种配色组合：

![MWordStar不同配色的截图](/docs/color1.png)

![MWordStar不同配色的截图](/docs/color2.png)

![MWordStar不同配色的截图](/docs/color3.png)

小头图模式：

![MWordStar小头图模式截图](/docs/small.png)

也可以给不同的文章设置不同的头图样式：

![MWordStar大头图和小头图搭配使用的截图](/docs/large-and-small.png)